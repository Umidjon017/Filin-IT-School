                        ...
                        <table class="table table-bordered table-striped table-md">
                            ...
                            @foreach($questions as $question)
                                <tr>
                                    ...
                                    <td class="text-break">{{ $question->name }}</td>
                                    <td class="text-break">{{ $question->email }}</td>
                                    <td class="text-break">{{ $question->question }}</td>
                                    <td class="text-break">{{ $question->answer }}</td>
                                    <td>
                                    ...
                                    <td class="d-flex justify-content-center">
                                         <a class="btn btn-primary" href="{{ route('admin.questions.show', $question->id) }}">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a class="btn btn-warning ml-1" href="{{ route('admin.questions.edit', $question->id) }}">
