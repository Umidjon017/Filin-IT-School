                ...
                <form action="{{ route('admin.footer-buttons.update', $footerButton->id) }}" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control" name="name" value="{{ $footerButton->name }}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input id="url" type="url" class="form-control" name="url" value="{{ $footerButton->url }}">
                            @error('url')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="order_number" type="number" class="form-control" name="order" value="{{ $footerButton->order }}">
                            @error('order')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="status" class="custom-switch mt-2">
                                <input id="status" type="checkbox" class="custom-switch-input" name="status" @if($footerButton->status == 1) checked @endif>
